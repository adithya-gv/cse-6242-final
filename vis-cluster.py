...
# Load data
df = pd.read_csv('game_data_with_clusters.csv')
...
category_order = ['Cluster 0', 'Cluster 1', 'Cluster 2', 'Cluster 3', 'Selected Game']  # Updated category order
...
def update_visualization(selected_features, selected_game):
    ...
    # Highlight the selected game or assign cluster labels
